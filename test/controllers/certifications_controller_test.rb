...
class CertificationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create certification" do
    assert_difference("Certification.count") do
      post certifications_url, params: { certification: { confirmed: @certification.confirmed, image_url: @certification.image_url, teacher: @certification.teacher, title: @certification.title } }
    end
  ...
  test "should update certification" do
    patch certification_url(@certification), params: { certification: { confirmed: @certification.confirmed, image_url: @certification.image_url, teacher: @certification.teacher, title: @certification.title } }
